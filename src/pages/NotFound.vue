<template>
  <main class="flex flex-col items-center justify-center min-h-screen text-center px-4 sm:px-6 lg:px-8">
    <lottie-player src="https://lottie.host/7d2a2456-9606-4937-8b78-838eda3d5601/PvNtDuJdqa.json" background="##FFFFFF" speed="1" class="lg:w-[500px]" loop autoplay direction="1" mode="normal"></lottie-player>
