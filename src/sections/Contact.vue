    ...
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-16 mx-auto">
      <div class="max-w-2xl lg:max-w-5xl mx-auto">
        <div class="text-center">
          ...
          <p class="mt-1 text-gray-600 dark:text-gray-400">We'd love to talk about how we can help you.</p>
        </div>
          ...
          <div class="divide-y divide-gray-200 dark:divide-gray-800">
            ...
            <div class="flex gap-x-7 py-6">
              ...
              <div class="grow">
                ...
                <a
                  class="mt-2 inline-flex hover:underline decoration-blue-500 items-center gap-x-2 text-sm font-medium text-gray-600 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                  href="mailto:contact@irvanshandika.my.id">
                  <span class="underline underline-offset-2 decoration-blue-500">contact@irvanshandika.my.id</span>
                </a>
              </div>
            </div>
            <!-- End Icon Block -->
