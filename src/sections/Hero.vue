<template>
  <section>
    <div class="grid max-w-screen-xl px-4 py-8 mx-auto my-10 lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
      <div class="place-self-center lg:col-span-7 order-2 lg:order-1">
        <h1 class="max-w-2xl lg:text-left text-center mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">
          Hi, I'm <span class="underline underline-offset-2 decoration-blue-500">Muhammad Irvan Shandika</span>
        </h1>
        ...
        <div class="flex mt-4 sm:mt-0 lg:justify-start justify-center">
          ...
          <a href="https://www.instagram.com/irvan_shandika/" class="text-gray-900 hover:text-gray-500 ms-5 dark:text-gray-100 dark:hover:text-gray-400" target="_blank" aria-label="Cek lebih lanjut media sosial saya">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5" viewBox="0 0 24 24">
              ...
              <circle cx="17" cy="7" r="1.5" fill="currentColor" fill-opacity="0"><animate fill="freeze" attributeName="fill-opacity" begin="1.1s" dur="0.4s" values="0;1" /></circle>
            </svg>
          </a>
        </div>
      </div>
